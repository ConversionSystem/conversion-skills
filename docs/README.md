...
- **[getting-started.md](getting-started.md)** · What you need, how to install, your first 10 minutes.
- **[commands.md](commands.md)** · Every command, what it does, what it needs.
- **[daily-use.md](daily-use.md)** · The operating rhythm. Day, week, month.
- **[setup-guide.md](setup-guide.md)** · The three profiles: Solo, Team, Agency.
